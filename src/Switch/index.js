...
//Original resource => https://codepen.io/ste-vg/pen/oNgrYOb
        ...
        <>
            <div className="layout">
                ...
                <label className="container">
                    <input id="input" onChange={toggle} type="checkbox" checked={isDay} />
                    <span className="checkmark">
                        ...
                        <svg id="toggle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 34" width="60" height="34">
                            ...
                            <g clipPath="url(#container)">
                                <use id="back" ref={back} href={`#${isDay ? 'day' : 'night'}`} />
                                <g clipPath="url(#switch)">
                                    <use id="front" ref={front} href={`#${isDay ? 'night' : 'day'}`} />
                                </g>
